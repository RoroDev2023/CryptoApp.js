...
const Badges = () => {
  return (
    <>
      <div class="flex justify-around space-x-28 container font-bold">
          <span class="bg-red-100 text-red-800 text-base mr-2 px-2 py-0.5 rounded dark:bg-red-900 dark:text-red-300 font-bold">#</span>
          ...
          <span class="bg-pink-100 text-pink-800 text-base mr-2 px-2 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300 font-bold">Mkt Cap</span>
      </div>
    </>
  )
}
